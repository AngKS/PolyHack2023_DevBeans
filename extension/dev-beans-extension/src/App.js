...
function App() {
  ...
  return (
    <div className="w-ext h-ext bg-background">
      {page == "Default" ?
        <>
          <div className="topNav w-11/12 mx-auto py-4 px-3 flex">
            ...
            <div className="flex gap-2 basis-1/6 items-center">
              ...
              <AiOutlineCloseCircle className="text-xl cursor-pointer hover:text-gray-400 duration-200"/>
            </div>
          </div>
        ...
        <>
          <div className="topNav w-11/12 mx-auto py-4 px-3 flex">
            ...
            <div className="flex gap-2 basis-1/6 items-center">
              ...
              <button id="button"><AiOutlineCloseCircle className="text-xl cursor-pointer hover:text-gray-400 duration-200" /></button>
            </div>
          </div>
          <div className="w-11/12 mx-auto px-3">
